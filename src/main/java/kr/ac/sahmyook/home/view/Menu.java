    ...
    public void subIfMenu(){
        ...
        do {
            ...
            switch(no) {
                ...
                default: System.out.println("잘못된 값 입력. 다시 입력해주세요.");
            }
        } while(true);
    };
        ...
        do {
            ...
            switch(menuNum) {
                ...
                case 9:
                    ...
                    return;
                default:
                    System.out.println("잘못된 값 입력시 메뉴 다시 출력되게 처리");
                    break;
            }
        } while(menuNum != 9);
    };
        ...
        do {
            ...
            switch (no) {
                ...
                case 4:
                    ...
                    return;
                default:
                    System.out.println("잘못된 값 입력. 메뉴 다시 출력됨.");
            }
        } while (true);
    };
        ...
        do {
            ...
            switch (menu) {
                ...
                case 3:
                    ...
                    return;
                default:
                    System.out.println("잘못된 값 입력시 메뉴가 다시 출력됩니다.");
                    break;
            }
        } while (true);
    };
